-- هذا الملف يقوم بتطبيق الإصلاحات على جدول profiles وسياسات أمان الصفوف
-- يجب تنفيذ هذا الملف في قاعدة البيانات لإصلاح مشكلة التكرار اللانهائي
...
-- 2. تعطيل سياسات أمان الصفوف مؤقتًا لجدول profiles
ALTER TABLE profiles DISABLE ROW LEVEL SECURITY;

-- 3. إعادة تمكين سياسات أمان الصفوف لجدول profiles
ALTER TABLE profiles ENABLE ROW LEVEL SECURITY;

-- 4. إنشاء سياسات أمان الصفوف الجديدة لجدول profiles
...
-- 5. إنشاء وظيفة RPC آمنة لتحديث الملف الشخصي بتجاوز سياسات أمان الصفوف
...
-- 6. إنشاء وظيفة للحصول على ملف شخصي محدد بواسطة معرف المستخدم
...
-- 7. إنشاء وظيفة للتحقق من وجود ملف شخصي
...
-- 8. منح صلاحيات تنفيذ الوظائف للمستخدمين المصادق عليهم وغير المصادق عليهم
