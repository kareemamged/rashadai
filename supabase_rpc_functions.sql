-- وظيفة للحصول على جميع الملفات الشخصية
...
-- وظيفة لتحديث ملف شخصي بتجاوز سياسات أمان الصفوف
...
BEGIN
  ...
  SET
    ...
    birth_date = COALESCE(p_profile_data->>'birth_date'::text::date, birth_date),
  ...
  IF updated_profile IS NULL THEN
    INSERT INTO profiles (
      ...
      (p_profile_data->>'birth_date')::text::date,
