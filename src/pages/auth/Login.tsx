            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm ltr:pr-10 rtl:pl-10 rtl:text-right"
                  placeholder="******"
                />
                <button
                  type="button"
