                    ...
                    <tr key={post.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                          ...
                          {post.status === 'published' ? (isRTL ? "منشور" : "Published") :
                           post.status === 'scheduled' ? (isRTL ? "مجدول" : "Scheduled") :
                           (isRTL ? "مسودة" : "Draft")}
                        </span>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        ...
                        <a
                          ...
                          title={t('admin.content.previewPost', 'Preview Post')}
                        >
                    ...
                    <tr key={comment.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                          ...
                          {(comment.approved || comment.status === 'approved') ? (isRTL ? "موافق عليه" : "Approved") : (isRTL ? "معلق" : "Pending")}
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    ...
                    <tr key={testimonial.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                          ...
                          {testimonial.approved ? (isRTL ? "موافق عليه" : "Approved") : (isRTL ? "معلق" : "Pending")}
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        {/* زر الموافقة/الرفض */}
