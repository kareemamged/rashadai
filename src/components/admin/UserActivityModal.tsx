          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <div className="mt-4">
              <p className="text-sm text-gray-500 mb-4">
                ...
                }).replace('{name}', user.name || user.email || 'User')}
              </p>
              ...
              <div className="mt-4 max-h-96 overflow-y-auto">
                {isLoading ? (
                  ...
                  <div className="text-center py-4">
                    <p className="text-sm text-gray-500">{t('admin.users.noActivities')}</p>
                  </div>
                ) : (
                        ...
                        <div className="flex items-start">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            {activity.device_info && (
                              <p className="mt-1 text-xs text-gray-500">
                                {t('admin.users.device')}: {activity.device_info.substring(0, 50)}{activity.device_info.length > 50 ? '...' : ''}
                              </p>
                            )}
                          </div>
                        </div>
