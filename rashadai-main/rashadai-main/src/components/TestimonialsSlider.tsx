          ...
          {filteredTestimonials.length > 1 && (
            <>
              <button
                ...
                className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-3 bg-white p-2 rounded-full shadow-md text-blue-600 hover:text-blue-700 focus:outline-none transition-transform hover:scale-110"
              >
              ...
              <button
                ...
                className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-3 bg-white p-2 rounded-full shadow-md text-blue-600 hover:text-blue-700 focus:outline-none transition-transform hover:scale-110"
              >
