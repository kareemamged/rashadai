          ...
          <div className="max-w-5xl mx-auto mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={index} className="bg-white p-6 rounded-xl shadow-md transition-all duration-300 hover:shadow-lg border border-gray-100">
          ...
          <div className="max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className={`relative ${language === 'ar' ? 'pr-8' : 'pl-8'} pb-12 ${language === 'ar' ? 'border-r-2' : 'border-l-2'} border-blue-200 last:border-transparent last:pb-0`}>
                <div className={`absolute ${language === 'ar' ? 'right-[-8px]' : 'left-[-8px]'} top-0 h-4 w-4 rounded-full bg-blue-600`}></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center mb-16">
            <div className="flex justify-center">
              <div className="h-16 w-48 bg-gray-200 rounded flex items-center justify-center text-gray-500 font-semibold">
