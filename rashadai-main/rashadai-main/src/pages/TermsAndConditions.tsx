          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-blue-50 p-6 rounded-xl">
                ...
                <a href="/privacy" className={`text-blue-600 hover:text-blue-800 font-medium ${language === 'ar' ? 'flex items-center' : ''}`}>
                  {language === 'ar'
              ...
              <div className="bg-blue-50 p-6 rounded-xl">
                ...
                <a href="/cookies" className={`text-blue-600 hover:text-blue-800 font-medium ${language === 'ar' ? 'flex items-center' : ''}`}>
                  {language === 'ar'
              ...
              <div className="bg-blue-50 p-6 rounded-xl">
                ...
                <a href="/hipaa-compliance" className={`text-blue-600 hover:text-blue-800 font-medium ${language === 'ar' ? 'flex items-center' : ''}`}>
                  {language === 'ar'
